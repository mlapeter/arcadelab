...
const meta = getLibraryMeta("three")!;

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: `Three.js scenes on ArcadeLab — 3D as single-file HTML`,
  description: meta.description,
  alternates: { canonical: "https://arcadelab.ai/three" },
  openGraph: {
    images: [{ url: "/opengraph-image", width: 1200, height: 630 }],
    title: `${meta.longName} on ArcadeLab`,
    description: meta.description,
    url: "https://arcadelab.ai/three",
    type: "website",
  },
};
